...
export function landmarkAngle(landmark1: Landmark, landmark2: Landmark, landmark3: Landmark) {
  const vector1 = [landmark2.x - landmark1.x, landmark2.y - landmark1.y, landmark2.z - landmark1.z];
  const vector2 = [landmark3.x - landmark2.x, landmark3.y - landmark2.y, landmark3.z - landmark2.z];
  const dot = vector1[0] * vector2[0] + vector1[1] * vector2[1] + vector1[2] * vector2[2];
